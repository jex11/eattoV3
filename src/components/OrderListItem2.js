...
class OrderListItem2 extends Component {
    constructor(props) {
        super(props);
        this.state = { x: false };                
    }
    ...
    onQuantityChange = (uid, num) => {    
        console.log('onQuantityChange', num);
        this.props.changeFoodQuantity(uid, num);        
    }

    render() {
        console.log('10. Order List Item 2 render');     
...
const mapStateToProps = state => {   
    console.log('9. OrderListItem2 mapStateToProps', state);
